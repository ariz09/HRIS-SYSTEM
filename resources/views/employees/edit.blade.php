                                ...
                                <div class="mb-4 text-center">
                                    <div class="profile-picture-container mb-3">
                                        @if($employee->personalInfo && $employee->personalInfo->profile_picture)
                                            <img id="currentProfilePic" src="{{ asset('storage/' . $employee->personalInfo->profile_picture) }}" 
                    ...
                    <div class="col-md-6">
                        <div class="card shadow-sm border-0 h-100">
                            ...
                            <div class="card-body d-flex flex-column align-items-center justify-content-center">
                                ...
                                <div class="text-muted small">New Picture Preview</div>
                                <button type="button" id="removeImageBtn" class="btn btn-sm btn-outline-danger mt-3 d-none"
                                        onclick="removeImage()">
